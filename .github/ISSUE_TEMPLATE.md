<!--
Thanks for taking the time to draft up an issue for Axon Framework's JGroups Extension!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Framework's JGroups Extension,
 please consider to check Axon's Reference Guide first if it answers your question: https://docs.axoniq.io/reference-guide/extensions/jgroups
...
You can find all three of them [here](https://github.com/AxonFramework/extension-jgroups/issues/new/choose). 
